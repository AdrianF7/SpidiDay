const CACHE='spididay-v2.3.8';
const APP_SHELL=['./','./index.html','./styles.css?v=25','./data/quotes.js?v=19','./data/motivation-messages.js?v=1','./db.js?v=12','./app.js?v=1.1.0','./story.js?v=2.3.1','./compass.js?v=15','./data/verses-rv1909.js','./manifest.webmanifest?v=2','./mascot-spidi-marea.svg?v=13','./decorations-marea.svg','./assets/origin-spididay.png','./fonts/Manrope-Variable.ttf','./fonts/Fraunces-Variable.ttf','./icons/icon-192.png?v=2','./icons/icon-512.png?v=2'];
